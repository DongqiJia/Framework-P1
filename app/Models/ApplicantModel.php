...
class ApplicantModel
{
    ...
    {
        $this->db->query('INSERT INTO `applicant` (`Gender`, `ApplicantNumber`, `FirstName`, `LastName`, `JobId`, `Email`, `Phone`, `BirthDate`, `Street`, `Number`, `NumberExtension`, `ZipCode`, `Place`, `Applicantkey`, `IsActive`, `Description`, `DateCreated`, `DateModified`, `Province`) VALUES (:Gender, :ApplicantNumber, :FirstName, :LastName, :JobId, :Email, :Phone, :BirthDate, :Street, :Number, :NumberExtension, :Zipcode, :Place, :Applicantkey, :IsActive, :Description, :DateCreated, :DateModified, :province)');
        ...
        $this->db->bind(':NumberExtension', $_POST['NumberExtension']);
